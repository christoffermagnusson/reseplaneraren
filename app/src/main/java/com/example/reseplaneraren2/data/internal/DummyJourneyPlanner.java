...
public class DummyJourneyPlanner implements IJourneyPlannerData {
    ...
    public DummyJourneyPlanner(){
        ...
        depList.add(new Departure("SVAR", "Amhult", "BUS", "C", new String[]{"11:18", "11:28", "11:38", "11:48", "11:58", "12:08"}, "#ffffff", "#000000", false));
        */
    }

    @Override
    public void getStopLocationByName(UIStopLocationHandler handler, String request) {
        handler.receiveStopLocationByName(stopListBySearch);
    }
